            ...
            while (event != XmlPullParser.END_DOCUMENT) {
                ...
                if (event == XmlPullParser.START_TAG) {
                    ...
                    if (currentTag.equals("a:WorkOrder")) {
                        ...
                        if(parser.getText()!=null) newWorkOrder.setWorkOrderId(Integer.getInteger(parser.getText()));
                        ...
                        if(parser.getText()!=null)customer.setPersonId(Integer.getInteger(parser.getText()));
                    }
                }
